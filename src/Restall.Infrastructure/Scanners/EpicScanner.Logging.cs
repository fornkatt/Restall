...
internal sealed partial class EpicScanner
{
    ...
    private partial void LogFailedToScanEpicManifest(string file, Exception ex);
    ...
    [LoggerMessage(EventId = 1654, Level = LogLevel.Debug,
        Message =
            "Failed to find the name for Epic Heroic Game with \"{AppName}\" and install path: \"{InstallPath}\"")]
