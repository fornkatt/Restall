...
public static partial class Log
{
    [LoggerMessage(EventId = 25, Level = LogLevel.Error,
        Message =
            "Failed to download \"{ModType}\" to cache \"{CacheDirectory}\" — Service returned: \"{ErrorMessage}\"")]
    ...
    [LoggerMessage(EventId = 27, Level = LogLevel.Error,
        Message =
            "Failed to delete existing \"{ModType}\" file on \"{GameName}\" — Service returned: \"{ErrorMessage}\"")]
